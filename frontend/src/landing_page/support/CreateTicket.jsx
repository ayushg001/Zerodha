       ...
       <div className="container">
        <div className="row p-5 mt-5">
            ...
            <div className="col-4 p-5 mt-2 mb-2">
                <h5 className="mb-4">
                    <i class="fa-solid fa-circle-plus"></i>    Account Opening </h5>
                   ...
                   <a href="" style={{textDecoration:"none" , lineHeight : "2.5"}}>WRI Account Opening </a> <br />
                  ...
                  <div className="col-4 p-5 mt-2 mb-2">
                   <h5 className="mb-4">
                   <i class="fa-solid fa-user"></i>   Your Zerodha Account </h5>
                  ...
                  <div className="col-4 p-5 mt-2 mb-2">
                   <h5 className="mb-4">
                   <i class="fa-brands fa-uikit"></i>   Kite </h5>
         ...
         <div className="row p-5 mb-5">
            ...
            <div className="col-4 p-5">
                <h5 className="mb-4">
                  <i class="fa-regular fa-credit-card"></i>   Funds</h5>
                  ...
                  <div className="col-4 p-5">
                   <h5 className="mb-4">
                <i class="fa-solid fa-c"></i>  Console </h5>
                  ...
                  <div className="col-4 p-5">
                   <h5 className="mb-4">
                   <i class="fa-regular fa-circle"></i>     Coin </h5>
